...
const HelpIntentHandler = {
  ...
  handle(handlerInput) {
    const speakOutput =
      'This is Cairo Quran Radio 24/7. You can say "play" to start listening, "pause" to pause, or "stop" to stop the radio. The radio will start playing automatically when you open the skill.'

    return handlerInput.responseBuilder.speak(speakOutput).reprompt("What would you like to do?").getResponse()
  },
}
...
const CancelAndStopIntentHandler = {
  ...
  handle(handlerInput) {
    ...
    return handlerInput.responseBuilder.speak(speakOutput).addAudioPlayerStopDirective().getResponse()
  },
}
/* *
